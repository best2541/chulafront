  ...
  return (
    <>
      ...
      {role == 3 &&
        <>
          <EditFooter />
          <EditNews datas={input} setDatas={inputChange} cancle={() => setInput(datas)} saveClick={saveClick} edit={edit} setEdit={setEdit} sendEmail={sendEmail} reportChange={reportChange} api={props.api} />
        </>
      }
