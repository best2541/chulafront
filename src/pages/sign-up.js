    ...
    <>
      ...
      <div class="container py-5">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-12 mb-4">
              <div class="button bt-select-type d-flex justify-content-center">
                ...
                <label class="btn btn-default" for="a25"><img img class="img-type" src="./images/select-type/select-type1.png" alt="" />
                  <p class="text-type">แหล่งกำเนิดอาหาร</p>
                </label>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12 mb-4">
              <div class="button bt-select-type d-flex justify-content-center">
                <input type="radio" id="a50" name="check-substitution-2" onClick={() => setType(3)} />
                <label class="btn btn-default" for="a50"><img class="img-type" src="./images/select-type/select-type2.png" alt="" />
                  <p class="text-type">ผู้รับขยะอาหาร</p>
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="wraper-textform d-flex flex-column mx-auto align-items-center">
          <button class="btn bg-green text-white w-100 rounded-pill" disabled={!type} onClick={submitClick}>ยืนยัน</button>
        </div>
